...
import type { Being } from "@/lib/protocol/types";

/**
 * TRANSITIONAL — exports `Logos` but renders a Being card.
 * Will be renamed to <Being> in the Phase 2 UI rework (task #22).
 */

const TYPE_TONE: Record<Being["type"], { bg: string; dot: string }> = {
...
export function Logos({ being, size = "card", selected, onClick }: LogosProps) {
  const tone = TYPE_TONE[being.type];
