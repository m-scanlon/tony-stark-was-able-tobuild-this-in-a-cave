...
Shards are compute actors — hardware fingerprint, network address, runtime environment. A shard has no skills. It has capabilities that describe what it can physically support or run.
