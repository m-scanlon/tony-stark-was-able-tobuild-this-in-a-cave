...
When the capability surface boundary is known, registration should also preserve:

- ingress for signal entering Skyra
- `act` for outbound interaction from Skyra

So a verified capability surface may expose:
...
## Relationship To Registered Surfaces

The registration record is not the same thing as the published public stimulus contract.
...
- registered capability surfaces preserve what downstream execution surfaces are real and whether each one is ingress, `act`, or both
- later `stewart` contracts provide the simplified public request/response abstraction other actors use

In other words:

- registration is the inventory and verification envelope
- capability surfaces are downstream execution surfaces
- public actor-facing contracts are the callable abstraction layer
...
5. preserve enough detail to register verified capability surfaces
6. write the registration envelope
7. register verified capability surfaces with explicit ingress / `act` boundary typing
8. birth or revise the relevant `stewart` actor
9. publish the simplified public request/response contract
...
- probing
- registration
- capability-surface registration
- public abstraction publication
- actor birth
...
- verified capability surfaces should preserve whether they expose ingress, `act`, or both
- registration, capability-surface registration, and public `stewart` contracts are related but distinct
