...
- `tool-contract.md` — the structured tool call contract Skyra uses when delegating work to Voice Shard.
...
**`personality.md`** is the runtime layer. It contains only rules that actively change output behavior. Kept as thin as possible to preserve context budget on smaller models (Voice Shard front-door model has 4k-8k context). No descriptive or observer-facing language.
