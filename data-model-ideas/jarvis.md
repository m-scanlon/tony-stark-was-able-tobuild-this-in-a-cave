...
`Jarvis` is the canonical name for the user-facing meaning node.
...
It is a node whose role is to track what matters, shape user-facing meaning, and carry continuity of attention across experience.
...
- Jarvis is the canonical user-facing meaning node

## Relationship To Stark

Jarvis and Stark are paired major node roles.

- Jarvis determines what matters in the user-facing sense
- Stark determines what structural arrangements should exist
...
It tends continuity, attention, and what matters from the user-facing side of the system.
