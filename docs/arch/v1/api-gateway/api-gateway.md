...
See `docs/arch/v1/shard/shard-communication.md` for the full communication protocol.
...
Nested calls keep the same `intent_scope_id` as the root call. If the scope cannot be proven, the gateway rejects the call.
...
- `docs/arch/v1/shard/shard-communication.md` — internal command protocol
- `docs/arch/v1/skill/skill-composition-protocol.md` — skill composition and intent-scope rules
