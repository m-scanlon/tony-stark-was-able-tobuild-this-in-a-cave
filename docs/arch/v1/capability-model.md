...
Shard capabilities are registered at boot via hardware fingerprinting and verification. See `docs/arch/v1/shard-registration.md`.
...
- `docs/arch/v1/shard-registration.md` — capability registration at boot
- `docs/arch/v1/api-gateway.md` — skill validation, job envelope assembly
