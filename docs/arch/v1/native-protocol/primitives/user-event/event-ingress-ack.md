...
- `docs/arch/v1/shard/shard-communication.md` — unified command protocol, shard primitives
- `docs/arch/v1/api-gateway/api-gateway.md` — ingress and transport boundary for the standalone kernel
