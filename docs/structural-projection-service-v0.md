...
- recall is driven by heavy inference calls over current episode context
- heavy inference emits bounded recall commands when recall is needed
- recall command results are written into `episode.recall`
